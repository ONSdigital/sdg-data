...
archive_types = {
    "deleted": "This indicator was deleted following [indicator changes]({{ site.baseurl }}/updates/2021/02/17/2020-indicator-changes.html) from the United Nations 2020 Comprehensive Review.",
    "replaced": "This indicator was replaced following [indicator changes]({{ site.baseurl }}/updates/2021/02/17/2020-indicator-changes.html) from the United Nations 2020 Comprehensive Review.",
    "revised": "This indicator was revised following [indicator changes]({{ site.baseurl }}/updates/2021/02/17/2020-indicator-changes.html) from the United Nations 2020 Comprehensive Review."
}
