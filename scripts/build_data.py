...
def alter_meta(meta):
    if 'indicator_number' in meta:
        ...
        if 'progress_status' in meta and meta['progress_status'] in ['target_achieved', 'close_to_target', 'moderate_distance_to_target',
          ...
          meta['page_content']= '<img src="http://uk-sdg-feature-branches.s3-website.eu-west-2.amazonaws.com/feature-progress-ut-june-2022/assets/img/progress/embed-test.png"><br>'+meta['page_content']
