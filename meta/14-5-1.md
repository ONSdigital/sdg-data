...
source_other_info_3: >-
  ...
  Country Profile</a> under the Key Biodiversity Areas tab.</p><p>Graphs of Protected area coverage of KBAs are also available for each country in the <a href="https://bipdashboard.natureserve.org/bip/SelectCountry.html"> BIP Indicator Dashboard<a/>, and the <a href="https://ibat-
  alliance.org/country_profiles"> Integrated Biodiversity Assessment Tool Country Profiles.<a/> Please not that data on the different websites may not be updated at the same time so may give slightly different figures.
