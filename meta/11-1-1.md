...
data_footnote: The data for some disaggregations are only available for households, these can be viewed by first selecting 'Household', and then the chosen sub-category. The data for the 'Urbanisation', and 'Sub-national' area categories are for dwellings only.
graph_type: line
