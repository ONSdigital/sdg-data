...
The maternal mortality ratio for the UK, following the UN specification, can also be found in the MBRRACE-UK reports using the link above.<br><br>Select the following link to download this indicator data in an accessible format:<br>[3.1.1 Maternal mortality ratio (CSV 6.02 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/3-1-1.csv)