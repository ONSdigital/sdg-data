...
comments_limitations: >-
  SDG 12.3 aims to reduce food loss and waste.  Current UK data is for food waste.
Hospitality and Food Services data are a modelled result, based on changes in the number and types of hospitality and food service sites, and the assumption that food waste per site has remained
  constant since 2011. Currently there is not a data source to enable a UK-level estimate for food waste from this sector to be robustly estimated.
