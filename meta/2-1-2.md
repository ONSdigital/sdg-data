...
---
There is a strong and growing user need for better statistics on food insecurity in the UK. The Department for Work and Pensions now include FIES food insecurity questions on the Family Resources Survey (FRS), with first results expected in 2021. In the meantime, data presented here come from the Food and You Survey run by the Food Standards Agency which includes questions from the food insecurity suite developed by the US Department of Agriculture, with data available for England, Wales and Northern Ireland.
