...
computation_calculations: No calculations were performed as the sources provide the data in the required form for the indicator.
reporting_status: complete
data_non_statistical: false
data_footnote: >-
  Labour Force Survey (LFS) responses have been reweighted to new populations derived using growth rates from HM Revenue and Customs (HMRC) Real Time Information (RTI), to allow for different trends during the coronavirus (COVID-19) pandemic. The reweighting will give improved estimates of
  both rates and levels for estimates from Q1 2020 onwards. However, during the implementation of this weighting methodology a small error was encountered resulting in a slight overestimation of the non-UK population by approximately 0.5%. This represents less than half the size of the
  sampling variability. The impact pm LFS economic activity estimates at national level is mostly below 0.1% and the impact on rates is less than 0.02 percentage points.
data_start_values:
  - field: Units
