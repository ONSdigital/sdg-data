...
---
Select the following link to download this indicator data in an accessible format:<br>[11.6.2 Annual mean levels of fine particulate matter (e.g. PM2.5 and PM10) in cities (population weighted) (CSV 18.366 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/11-6-2.csv)