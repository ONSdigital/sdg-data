...
computation_calculations: >-
  ...
  Additional breakdown is provided for the different recipient countried income groups. All CRS codes used to measure gross ODA flows to scholarship-related sectors fall under Type of Aid code E01 (see Source 1). The indicator required gross disbursements of ODA, so the amount extended
  value was used to do the sums, rather than the headline ODA value.
