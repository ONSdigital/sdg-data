...
computation_calculations: >-
  ...
  All CRS codes used to measure net ODA flows to scholarship-related sectors fall under Type of Aid code E01 (see Source 1).
reporting_status: complete
data_non_statistical: false
graph_type: line
graph_title: Net Official Development Assistance (ODA) for scholarships
data_show_map: false
data_keywords: ODA
