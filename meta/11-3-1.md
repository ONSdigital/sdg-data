...
---
Select the following link to download this indicator data in an accessible format:<br>[11.3.1 Ratio of land consumption rate to population growth rate (CSV 162.34 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/11-3-1.csv)