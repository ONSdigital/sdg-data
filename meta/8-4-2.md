...
computation_calculations: <p>No calculations were performed in the data acquisition for DMC and DMC per capital as appropriate data was readily available in the final format specified by this indicator.</p><p>Domestic Material per GDP is calculated as DMC/GDP.</p>
...
source_other_info_2: Based on GDP estimates published on 30/06/2020
...
---
Select the following link to download this indicator data in an accessible format:<br>[8.4.2 Domestic material consumption, domestic material consumption per capita, and domestic material consumption per GDP (CSV 35.848 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/data/8-4-2.csv)