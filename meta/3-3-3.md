...
precision:
  - series: Rate per 100,000 population
    decimals: 2
  - series: Number of cases
    decimals: 1
  - series: Percentage (%) of total cases
    decimals: 3

footer_fields:
  - unit: Rate per 100,000 population
    label: My field for rate
    value: My field content (rate)
  - unit: Number
    label: My field for number
    value: My other field content (number)
  - unit: Percentage (%)
    label: My field for %
