...
---
Select the following link to download this indicator data in an accessible format:<br>[16.1.2 Conflict-related deaths per 100,000 population, by sex, age and cause (CSV 3.063 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/16-1-2.csv)