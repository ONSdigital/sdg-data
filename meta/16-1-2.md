...
comments_limitations: >-
  This indicator only includes deaths as a result of direct cause of conflict (as a result of hostile action - see definitions) and does not include indirect deaths. Direct deaths are deaths where there are reasonable grounds to believe that they resulted directly from war operations and
