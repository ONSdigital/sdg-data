...
data_footnote: >-
  ...
  questions with an adjustment applied to make them comparable to the new questions. 3. Data broken down by income is not available for 18/19 as this data was not collected in the survey. 4. Physical violence figures are based on those aged 16 and over. Sexual violence figures use aged
  16-59 population. 5. Highest qualification for sexual violence series is only available once gender is selected. 6. Please note the y axis does not go to 100% for ease of visualisation.
graph_type: line
data_show_map: false
