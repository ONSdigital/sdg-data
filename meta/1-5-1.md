...
---
Select the following link to download this indicator data in an accessible format:<br>[1.5.1 Number of deaths, missing persons and directly affected persons attributed to disasters per 100,000 population (repeat of 11.5.1 and 13.1.1) (CSV 176.406 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/1-5-1.csv)