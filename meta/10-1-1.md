...
---
Select the following link to download this indicator data in an accessible format:<br>[10.1.1 Growth rates of household expenditure or income per capita among the bottom 40 per cent of the population and the total population (CSV 3.223 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/10-1-1.csv)