...
---
Select the following link to download this indicator data in an accessible format:<br>[11.5.1 Number of deaths, missing persons and directly affected persons attributed to disasters per 100,000 population (CSV 427.156 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/data/11-5-1.csv)