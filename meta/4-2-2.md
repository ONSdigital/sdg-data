...
---
Select the following link to download this indicator data in an accessible format:<br>[4.2.2 Participation rate in organized learning (one year before the official primary entry age), by sex (CSV 234.62 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/4-2-2.csv)