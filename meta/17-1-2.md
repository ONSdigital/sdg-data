...
source_other_info_1: <p>General government data are acquired from tab SO-GG, Code 11 Total Taxes, Code 2 Expense, and Code 31 Net investments in non-financial assets.</p><p>The original source is published monthly, but this indicator is updated annually.</p>
...
other_info: >-
  The government expenditure data used for the calculations is based on the IMF’s Government Finance Statistics Manual 2014 (GFSM). See the <a
