...
---
Select the following link to download this indicator data in an accessible format:<br>[3.9.1 Mortality rate attributed to household and ambient air pollution (CSV 110.676 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/3-9-1.csv)