...
computation_units: GBP, USD at average 2020 rate
...
computation_calculations: >-
  Net ODA flows are summed together for the respective year, and disaggregated by country income group (see Source 1). The dollar value is calculated based on average annual exchange rate for 2020 as specified by the Average Sterling exchange rate - US Dollar (see Source 2)
