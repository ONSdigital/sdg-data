...
data_footnote: <p> 1. Values between 1-7 are rounded to 5. All other values are rounded to the nearest 5.</p><p> 2. Individuals refers to all patients in the reporting period where FGM was identified or a procedure for FGM was undertaken. </p><p> 3. Each patient is only counted once. </p>
graph_type: line
graph_titles:
  - ~ series: Percentage  (%)
