...
data_footnote: >-
  <p> 1. Where applicable, figures in the chart and table are rounded to 3 significant figures. Unrounded values are available in the csv downloads below the chart or table. </p><p>2. Values between 1-7 are rounded to 5. All other values are rounded to the nearest 5.</p><p> 3. Individuals
