...
computation_definitions: >-
  ...
  classifications: <p/> <p> At risk of underweight includes those with a BMI less than or equal to the 2nd centile <p/> <p> At risk of overweight includes those with a BMI of greater than or equal to the 85th and less than the 95th centile <p/> <p> At risk of obesity includes those with a
  BMI greater than or equal to the 95th centile
...
---
<p>Data using the WHO Child Growth Standards is available for England only. <p/> <p> Data which uses BMI classifications is available for the 4 countries of the UK. However, as the data is acquired from different data sources for each, it is not possible to provide an overall UK figure. 