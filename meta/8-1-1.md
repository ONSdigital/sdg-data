...
national_indicator_description: >-
  This indicator shows the percentage change (latest year on previous year) in Gross Domestic Product (GDP) per capita at market prices. This differs from data presented on the <a href="https://unstats.un.org/sdgs/indicators/database/" target="_blank">UN SDG database</a>, as values have
  not been converted to US dollars (see the Global metadata for more information).
