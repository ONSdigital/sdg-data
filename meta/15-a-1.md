...
csv_size: 23.111 kB
indicator_available: Total Official Development Assistance (ODA) for biodiversity and revenue generated and finance mobilized from biodiversity-relevant economic
  instruments
...
source_other_info_2: >-
  To download the full dataset, export your customised table as a text file (csv) rather than an Excel file. <p><b>Selections under customise:</b></p> <p>Country = United Kingdom</p> <p>Variable = all except % of environmentally related tax revenue and the two with USD PPP</p>  <p>Category
  = All tax bases</p> <p>Environmental domain = Biodiversity</p>
