...
---
Select the following link to download this indicator data in an accessible format:<br>[2.a.2 Total official flows (official development assistance plus other official flows) to the agriculture sector (CSV 51.191 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/2-a-2.csv)