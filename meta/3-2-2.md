...
---
Select the following link to download this indicator data in an accessible format:<br>[3.2.2 Neonatal mortality rate (CSV 47.783 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/data/3-2-2.csv)