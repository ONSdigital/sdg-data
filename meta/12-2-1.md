...
computation_calculations: >-
  <p>Material footprint is available in "thousands of tonnes" from the original source (see Source 1), but here it is displayed as "millions of tonnes" to reduce the digits on the y-axis of the plot. This is done by dividing the data from the original source by 1000.</p>
