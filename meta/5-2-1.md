...
data_footnote: >-
  1. Not all data categories are available for the year 2007 to 2008 because comparable questions on any domestic abuse, any partner abuse and any family abuse were not included in that year. 2. New questions were introduced into the survey from the year ending March 2013, and estimates
  from this year onwards are calculated using these new questions. Estimates for earlier years are calculated from the original questions with an adjustment applied to make them comparable to the new questions. 3. The sum of the overarching domestic abuse categories are not the sum of the
  sub-categories, as some victims may be included in multiple categories as they can experience more than one type of abuse. 4. Data for some ethnic groups are unavailable due to small sample sizes.
data_start_values:
  - field: Series
    value: Women aged 16 to 74 (%)
graph_type: line
