...
other_info: >-
  ...
  experts.
---
Select the following link to download this indicator data in an accessible format:<br>[8.4.1 Material footprint, material footprint per capita, and material footprint per GDP (CSV 18.37 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/8-4-1.csv)