...
csv_size: 65.021 kB
indicator_available: Material footprint, material footprint per capita, and material footprint per GDP
un_designated_tier: Tier II
un_custodian_agency: United Nations Environment Programme (UNEP)
goal_meta_link: https://unstats.un.org/sdgs/metadata/files/Metadata-08-04-01.pdf 
goal_meta_link_text: United Nations Sustainable Development Goals Metadata (PDF 4.0 MB)
national_geographical_coverage: United Kingdom
computation_units: Million metric tons, Tons per capita, Tons per GDP (£m), Kilograms per constant USD ($) expressed in 2021 prices
computation_definitions: >-
  ...
  approach used can impact on the figures. These data give the latest estimates using a method developed by the University of Leeds, updating the time series where revised data are available, and including figures for 2020. Data are presented for the UK.</p> <p>Previously, there were
...
available_disaggregations: <p>Biomass, metal ores excluding precious metals, non-metallic minerals and fossil fuels.</p>
computation_calculations: >-
  ...
  sustainable-development/development-finance-standards/informationnoteonthedacdeflators.htm">OECD method</a>, expressed in 2021 prices (the latest deflator at the time of conversion). The average annual coversion rate for GBP into USD, and the deflators necessary for the constant USD
...
graph_titles:
  - series: Material footprint per unit of GDP
    ...
    title: Material footprint per GDP (kilograms per constant USD in 2021 prices)
  - series: Material footprint per unit of GDP
...
source_other_info_1: Data produced by the University of Leeds for 1990 to 2020, using a Multi-Region Input-Output model.
