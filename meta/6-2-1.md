...
---
Select the following link to download this indicator data in an accessible format:<br>[6.2.1 Proportion of population using (a) safely managed sanitation services and (b) a hand-washing facility with soap and water (CSV 0.0 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/en/data/6-2-1.csv)