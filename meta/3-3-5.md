...
data_footnote: 1. Headline figures include number of reported cases of Dengue Fever and Chikungunya for England, Wales and Northern Ireland only. 2. United Kingdom figures for Rabies can be seen when selected from the series field. 3. Timescales are not consistent across graphs.
graph_type: line
graph_titles:
