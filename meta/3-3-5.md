...
national_geographical_coverage: England, Wales and Northern Ireland, United Kingdom
computation_units: Number of cases
reporting_status: complete
data_non_statistical: false
data_footnote: >-
  1. Headline figures include number of reported cases of Dengue Fever and Chikungunya for England, Wales and Northern Ireland only. 2. United Kingdom figures for Rabies can be seen when selected from the series field. 3. Timescales and geographical coverage are not consistent across
  graphs.
graph_type: line
graph_titles:
  - series: Chikungunya and Dengue fever
